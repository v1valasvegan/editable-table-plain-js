...
var _fetchUsers = require("./fetchUsers");
var _fetchUsersDefault = parcelHelpers.interopDefault(_fetchUsers);
...
const makeCellInput = (name, value)=>{
    ...
    errorMessage.innerText = _errorMessagesDefault.default[name];
...
const App = async ()=>{
    const container1 = document.getElementById('table-body');
    const loader = document.createElement('div');
    loader.classList.add('loader');
    loader.innerText = '...Loading';
    container1.append(loader);
    const users = await _fetchUsersDefault.default();
    let state1 = [
        ...users
    ];
    ...
    const makeDeleteHandler = (uid)=>()=>{
            state1 = state1.filter(({ id  })=>id !== uid
            );
            render(state1);
        }
    ;
    const makeEditToggleHandler = (uid, isEditing)=>()=>{
            state1 = state1.map((user)=>user.id === uid ? {
                    ...user,
                    isEditing
                } : user
            );
    ...
    const makeSaveUserHandler = (uid)=>(e)=>{
            ...
            const validationState = _validation.validate({
                name,
                phone
            });
            _validation.handleValidation(e.target, validationState);
    ...
    const render = (state)=>{
        ...
        const children = state.map((user)=>user.isEditing ? makeEditableRow(user) : makeRow(user)
        );
        container.innerHTML = '';
    ...
    form1.addEventListener('submit', addUser);
};
App();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./fetchUsers":"2mgaM","./errorMessages":"lb1pr","./validation":"6Dpgn"}],"gkKU3":[function(require,module,exports) {
...
},{}],"2mgaM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = ()=>new Promise((resolve)=>setTimeout(()=>resolve([
                {
                    id: 0,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lb1pr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6Dpgn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "validate", ()=>validate
);
parcelHelpers.export(exports, "handleValidation", ()=>handleValidation
);
...
const handleValidation = (form, validationState)=>{
    ...
    [
        ...
        if (!validationState[input.name]) input.classList.add('invalid');
        if (validationState[input.name]) input.classList.remove('invalid');
    });
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aPJuQ","bB7Pu"], "bB7Pu", "parcelRequire94c2")
